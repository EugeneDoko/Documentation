GAMBannerView *outstreamView = [[GAMBannerView alloc] initWithAdSize:GADAdSizeBanner];
    outstreamView.adUnitID = @"YOUR_GAM_AD_UNIT_ID";
    outstreamView.rootViewController = self;
    outstreamView.delegate = self;
    [SmaatoSDK prebidOutstreamForAdSpaceId:@"SMAATO_ADSPACE_ID" bannerSize:kSMAUbBannerSizeXXLarge_320x50 completion:^(SMAUbBid * _Nullable bid, NSError * _Nullable error) {
